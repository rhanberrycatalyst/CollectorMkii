...
public class Collectible {
	...
	public enum CollectibleKeyWords{
		...
		/* all possible keywords that can be used to search
		 * for a particular collectible HERE
		 * Example: SPORTS, MOVIES, ANTIQUES
		 * Keywords are definite (will not be updated once assigned)
		 */ 
